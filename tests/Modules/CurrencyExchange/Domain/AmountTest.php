...
class AmountTest extends TestCase
{
    ...
    public function getCreationFloatExamples(): array
    {
        return [
            ...
            [1.0, 1.0],
            [1.1, 1.1],
            [3.141592653589793238462643383279502884197, 3.1416],
        ];
    }
    ...
    public function multiplyExamples(): array
    {
        return [
            ...
            [1, 0.01, 0.01],
            [2, 3.3, 6.6],
            [3.141592653589793238462643383279502884197, 3.141592653589793238462643383279502884197, 9.8696],
        ];
    }
    ...
    public function divideExamples(): array
    {
        return [
            ...
            [6, 3, 2],
            [1, 2, 0.5],
            [9.86958, 3.141592653589793238462643383279502884197, 3.1416],
        ];
    }
    ...
    public function addExamples(): array
    {
        return [
            [1, 1, 2],
            [0.1, 1, 1.1],
            [3.141592653589793238462643383279502884197, 3.141592653589793238462643383279502884197, 6.2832],
        ];
    }
}
